...
from mcp_server.config import DANGEROUS_SHELL_PATTERNS, MAX_EXECUTION_TIME, MAX_INPUT_LENGTH, MAX_OUTPUT_LENGTH, WORK_DIR
...
async def execute_shell_command(
    ...
    try:
        ...
        cwd = str(working_dir) if working_dir else str(WORK_DIR)
        ...
        try:
            ...
            try:
                ...
                proc.terminate()
            logger.warning(f"Shell 執行超時 ({timeout}s)，進程已終止")
