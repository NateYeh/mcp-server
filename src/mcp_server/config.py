...
OLLAMA_WEB_SEARCH_URL = os.getenv(
    ...
    "https://gpt-load.nate.idv.tw:8443/proxy/ollama/api/web_search"
)
OLLAMA_WEB_FETCH_URL = os.getenv(
    "OLLAMA_WEB_FETCH_URL",
    "https://gpt-load.nate.idv.tw:8443/proxy/ollama/api/web_fetch"
)
...
GEMINI_PROXY_URL = os.getenv(
    "GEMINI_PROXY_URL",
    "http://192.168.77.140:47300/proxy/gemini"
)
OLLAMA_PROXY_URL = os.getenv(
    "OLLAMA_PROXY_URL",
    "http://192.168.77.140:47300/proxy/ollama"
)
